...
proc ::elixir::elixirgui {} {
	...
	# set ::elixir::ph2data [dict create]
...
proc ::elixir::ph1add {} {
	...
	$t.subtable.tree insert {} end -id $::elixir::ph1index -text "$::elixir::ph1vn   $::elixir::ph1x: $::elixir::ph1y: $::elixir::ph1z"
...
proc ::elixir::ph1del {} {
	...
	if {![string equal [$t.subtable.tree selection] ""]} {
		lset ::elixir::ph1indexs 0 [$t.subtable.tree selection] 0
...
proc ::elixir::ph2add {} {
	...
	$t.subtable2.tree insert {} end -id $::elixir::ph2index -text "$::elixir::ph2vn   $::elixir::ph2x: $::elixir::ph2y: $::elixir::ph2z"
