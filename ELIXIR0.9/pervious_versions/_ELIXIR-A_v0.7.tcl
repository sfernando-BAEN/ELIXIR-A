...
namespace eval ::elixir:: {
	...
	variable ph2indexs [list [lrepeat 500 0]];
	variable ph2index 0;
...
proc ::elixir::elixirgui {} {
	...
	entry $t.ph1.entry1 -width 8 -textvariable ::elixir::ph1vn 
	...
	set ::elixir::ph1data [dict create]
	...
	entry $t.ph2.entry1 -width 8 -textvariable ::elixir::ph2vn 
	...
	grid $t.op.label01 $t.op.cd $t.op.browse -pady 10
	pack $t.op
	frame $t.op2
	...
	checkbutton $t.op2.cb2 -state disable -variable ::elixir::jsonout
...
proc ::elixir::ph1add {} {
	...
	$t.subtable.tree insert {} end -id $::elixir::ph1index -text "$::elixir::ph1vn"
	$t.subtable.tree insert $::elixir::ph1index end -text "Pharmacophore type:  $::elixir::ph1type"
	$t.subtable.tree insert $::elixir::ph1index end -text "X:  $::elixir::ph1x"
	$t.subtable.tree insert $::elixir::ph1index end -text "Y:  $::elixir::ph1y"
	$t.subtable.tree insert $::elixir::ph1index end -text "Z:  $::elixir::ph1z"
...
proc ::elixir::ph1del {} {
	variable t;
	$t.subtable.tree delete [$t.subtable.tree selection]
...
proc ::elixir::ph2add {} {
	...
	$t.subtable2.tree insert {} end -id $::elixir::ph2index -text "$::elixir::ph2vn"
	$t.subtable2.tree insert $::elixir::ph2index end -text "Pharmacophore type:  $::elixir::ph2type"
	$t.subtable2.tree insert $::elixir::ph2index end -text "X:  $::elixir::ph2x"
	$t.subtable2.tree insert $::elixir::ph2index end -text "Y:  $::elixir::ph2y"
	$t.subtable2.tree insert $::elixir::ph2index end -text "Z:  $::elixir::ph2z"
...
proc ::elixir::ph2del {} {
	variable t;
	$t.subtable2.tree delete [$t.subtable2.tree selection]
	#Check the status of the selected atom
	puts [$t.subtable2.tree selection]
}
...
set output [exec python "hello.py"] [list $ph2indexs]
#test on 
# set output [exec python [file join $::env(ELIXIRDIR) "elixirA.py"] [list $p_current]]
puts $output
