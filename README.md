...
### Step 1. Load the first pharmacophore file [5I3P.pdb](.ELIXIR-A/Example/Input/Dengue_NS5_RdRp/5I3P.json.pdb) with ``` Import pdb file ``` icon at the first pharmacophore cluster area.

### Step 2. Load the second pharmacophore file [5I3Q.pdb](.ELIXIR-A/Example/Input/Dengue_NS5_RdRp/5I3Q.json.pdb) with ``` Import pdb file ``` icon  at the second pharmacophore cluster area. 
